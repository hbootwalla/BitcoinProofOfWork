...
defmodule Project1.CLI do
  ...
  def main(args \\ []) do
    ...
    # If command line argument is a number, start the server 
      ...
      try do
        #ipaddr = "192.168.0.2"   #	Before running the server, ensure that IP ADDRESS is inserted here
        #if(ipaddr == "") do throw "Insert IP Address of Server Machine on line 143 and recompile" end
        ipaddr = Helper.findIP    # IF IP Address cannot be automatically accessed, please enter IP Address here
